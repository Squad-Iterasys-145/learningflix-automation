...
Given('que estou logado como cliente', async function () {
...
When('clico em Editar na variante marcada como padrao', async function () {
...
Then('A opcao Excluir nao deve ser exibida', async function () {
const botaoExcluir = this.page.getByRole('menuitem', { name: 'Excluir' })
